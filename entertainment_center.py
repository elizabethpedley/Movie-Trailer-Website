...
star_wars_the_last_jedi = media.Movie("Star Wars: The Last Jedi",
                                      "Rey continues her epic journey with Finn"
                                      ", Poe and Luke Skywalker in the next "
                                      "chapter of the saga.",
...
guardians_of_the_galaxy = media.Movie("Guardians of the Galaxy",
                                      ...
                                      "fanatical warrior from taking control of"
                                      " the universe.",
...
freedom_writers = media.Movie("Freedom Writers",
                              "A teacher in a racially divided school who gives"
                              " her students what they've always needed - a "
                              "voice",
...
mean_girls = media.Movie("Mean Girls",
                         "Story about a girl who try to make it in the popular "
                         "clique at her new school.",
...
the_heat = media.Movie("The Heat",
                       "An uptight FBI Special Agent is paired with a "
                       "foul-mouthed Boston cop to take down a ruthless drug "
                       "lord.",
...
movies = [star_wars_the_last_jedi, guardians_of_the_galaxy, freedom_writers,
